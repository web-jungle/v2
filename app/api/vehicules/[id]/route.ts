...
export async function GET(request: Request, props: { params: Promise<{ id: string }> }) {
  ...
  try {
    ...
    const formattedVehicule = {
      ...vehicule,
      dateMiseEnCirculation: vehicule.dateMiseEnCirculation ? new Date(vehicule.dateMiseEnCirculation) : null,
...
export async function PUT(request: Request, props: { params: Promise<{ id: string }> }) {
  ...
  try {
    ...
    const vehiculeData = {
      ...data,
      dateMiseEnCirculation: data.dateMiseEnCirculation ? new Date(data.dateMiseEnCirculation) : null,
      dateLimiteControleTechnique: data.dateLimiteControleTechnique ? new Date(data.dateLimiteControleTechnique) : null,
      dateLimiteControlePollution: data.dateLimiteControlePollution ? new Date(data.dateLimiteControlePollution) : null,
    }
