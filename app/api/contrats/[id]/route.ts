  ...
  try {
    ...
    if (!contrat) {
      return NextResponse.json(
        { error: "Contrat de maintenance non trouvé" },
        { status: 404 }
      );
    }
    ...
    console.error(
      "Erreur lors de la récupération du contrat de maintenance:",
      error
    );
    return NextResponse.json(
      { error: "Erreur lors de la récupération du contrat de maintenance" },
      { status: 500 }
    );
  }
}
...
export async function PUT(
  ...
  try {
    ...
    console.error(
      "Erreur lors de la mise à jour du contrat de maintenance:",
      error
    );
    return NextResponse.json(
      { error: "Erreur lors de la mise à jour du contrat de maintenance" },
      { status: 500 }
    );
  }
}
...
export async function DELETE(
  ...
  try {
    ...
    console.error(
      "Erreur lors de la suppression du contrat de maintenance:",
      error
    );
    return NextResponse.json(
      { error: "Erreur lors de la suppression du contrat de maintenance" },
      { status: 500 }
    );
  }
}
