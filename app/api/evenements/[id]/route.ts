...
export async function PATCH(req: Request, props: { params: Promise<{ id: string }> }) {
  ...
  try {
    ...
    if (data.collaborateurId !== undefined) prismaData.collaborateurId = data.collaborateurId
    if (data.typeEvenement !== undefined) prismaData.typeEvenement = data.typeEvenement
    if (data.lieuChantier !== undefined) prismaData.lieuChantier = data.lieuChantier
    if (data.zoneTrajet !== undefined) prismaData.zoneTrajet = data.zoneTrajet
    if (data.panierRepas !== undefined) prismaData.panierRepas = Boolean(data.panierRepas)
    if (data.ticketRestaurant !== undefined) prismaData.ticketRestaurant = Boolean(data.ticketRestaurant)
    if (data.heuresSupplementaires !== undefined) prismaData.heuresSupplementaires = Number(data.heuresSupplementaires)
    if (data.grandDeplacement !== undefined) prismaData.grandDeplacement = Boolean(data.grandDeplacement)
    if (data.prgd !== undefined) prismaData.prgd = Boolean(data.prgd)
    if (data.nombrePrgd !== undefined) prismaData.nombrePrgd = Number(data.nombrePrgd)
    if (data.typeAbsence !== undefined) prismaData.typeAbsence = data.typeAbsence
    if (data.verrouille !== undefined) prismaData.verrouille = Boolean(data.verrouille)
    ...
    if (data.adresseComplete !== undefined) prismaData.adresseComplete = data.adresseComplete
